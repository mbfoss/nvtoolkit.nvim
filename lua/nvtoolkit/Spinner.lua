local timer = require('nvtoolkit.timer')

---@class nvtoolkit.Spinner
---@field frames string[]
...
---@alias nvtoolkit.SpinnerOpts {frames?:string[], interval?:integer, on_update?:fun(frame:string, index:integer)}

---@class nvtoolkit.Spinner
---@field new fun(self:nvtoolkit.Spinner,opts:nvtoolkit.SpinnerOpts):nvtoolkit.Spinner
local Spinner = {}
...
---@param opts nvtoolkit.SpinnerOpts?
