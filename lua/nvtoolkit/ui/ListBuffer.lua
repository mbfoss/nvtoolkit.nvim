...
---@alias nvtoolkit.ui.ListBuffer.FormatterFn fun(id:any, data:any):string[][], string[][]

---@class nvtoolkit.ui.ListBuffer.Opts
---@field formatter nvtoolkit.ui.ListBuffer.FormatterFn
---@field on_selection fun(id:any, data:any)?
---@field current_item_prefix string?
---@field buffer_options vim.bo?

local _ns_id = vim.api.nvim_create_namespace('nvtoolkitListBuffer')

---@class nvtoolkit.ui.ListBuffer
---@field _buf integer
---@field _formatter nvtoolkit.ui.ListBuffer.FormatterFn
...
---@param opts nvtoolkit.ui.ListBuffer.Opts
---@return nvtoolkit.ui.ListBuffer
function ListBuffer.new(opts)
    local self = setmetatable({}, ListBuffer)

    self._buf = uitool.create_sratch_buffer(false, opts.buffer_options)
