local Tree = require("nvtoolkit.Tree")
local uitool = require("nvtoolkit.ui.utils")
local Signal = require("nvtoolkit.Signal")

---@class nvtoolkit.ui.TreeBuffer.Item
---@field id any
---@field data any
---@field expandable boolean
---@field expanded boolean

---@class nvtoolkit.ui.TreeBuffer.ItemDef
---@field id any
---@field data any
---@field expandable boolean?
---@field expanded boolean?

---@class nvtoolkit.ui.TreeBuffer.ItemData
---@field userdata any
---@field expandable boolean?
---@field expanded boolean?

---@alias nvtoolkit.ui.TreeBuffer.FormatterFn fun(id:any, data:any, expanded:boolean):string[][], string[][]

---@class nvtoolkit.ui.TreeBuffer.Opts
---@field filetype string?
---@field formatter nvtoolkit.ui.TreeBuffer.FormatterFn
...
---@class nvtoolkit.ui.TreeBuffer
---@field private _filetype string?
---@field private _formatter nvtoolkit.ui.TreeBuffer.FormatterFn
...
---@field private _on_selection nvtoolkit.Signal<fun(id:any,data:any)>
---@field private _on_toggle nvtoolkit.Signal<fun(id:any,data:any,expanded:boolean)>
---@field private _bufnr integer
---@field private _tree nvtoolkit.Tree
...
---@param opts nvtoolkit.ui.TreeBuffer.Opts
---@return nvtoolkit.ui.TreeBuffer
function TreeBuffer.new(opts)
    ...
    return setmetatable({
        ...
        _on_selection   = Signal.new(), ---@type nvtoolkit.Signal<fun(id:any,data:any)>
        _on_toggle      = Signal.new(), ---@type nvtoolkit.Signal<fun(id:any,data:any,expanded:boolean)>
        _bufnr          = -1,
        _tree           = Tree.new(),
        _flat_ids       = {}, ---@type any[]
...
function TreeBuffer:create_buffer(on_deleted)
    ...
    self._bufnr = uitool.create_sratch_buffer(false, {
        buftype      = "nofile",
        bufhidden    = "wipe",
        filetype     = self._filetype or "nvtoolkit-tree",
        modifiable   = false,
        swapfile     = false,
        undolevels   = -1,
        buflisted    = false,
...
---@private
---@param flatnode nvtoolkit.Tree.FlatNode
---@param row integer
...
---@param new_flat nvtoolkit.Tree.FlatNode[]
...
---@private
---@return any?, nvtoolkit.ui.TreeBuffer.ItemData?
...
---@param children nvtoolkit.ui.TreeBuffer.ItemDef[]
---@return boolean
