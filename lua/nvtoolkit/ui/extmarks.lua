...
---@class nvtoolkit.ui.extmarks.MarkInfo
---@field id number
---@field file string
...
---@class nvtoolkit.ui.extmarks.MarkData
---@field id number
---@field group string
---@field ns number
---@field lnum number        -- 1-based
...
---@alias nvtoolkit.ui.extmarks.ById table<number, nvtoolkit.ui.extmarks.MarkData>
---@alias nvtoolkit.ui.extmarks.ByFile table<string, nvtoolkit.ui.extmarks.ById>

---@class nvtoolkit.ui.extmarks.GroupData
---@field ns number
---@field byfile nvtoolkit.ui.extmarks.ByFile
---@field id_to_file table<number, string>

---@class nvtoolkit.ui.extmarks.GroupInfo
---@field priority number
---@field data nvtoolkit.ui.extmarks.GroupData

---@type table<string, nvtoolkit.ui.extmarks.GroupInfo>
...
---@param bufnr integer
---@param mark nvtoolkit.ui.extmarks.MarkData
...
local function _ensure_init()
    ...
    local augroup = vim.api.nvim_create_augroup("Nvtoolkit_ExtMarks", { clear = true })
...
local function _set_file_extmark(id, file, lnum, col, group, opts, user_data)
    ...
    ---@type nvtoolkit.ui.extmarks.MarkData
    local mark = {
        id = id,
        group = group,
        ns = group_data.ns,
...
---@param id number
---@param group string
---@return nvtoolkit.ui.extmarks.MarkInfo?
...
local function _get_extmarks(group, live)
    ...
    ---@type nvtoolkit.ui.extmarks.MarkInfo[]
    local result = {}
...
local function _get_file_extmarks(file, group, live)
    ...
    for _, g_info in pairs(groups) do
...
---@class nvtoolkit.ui.extmarks.GroupFunctions
...
---@field get_extmark_by_id fun(id:number):nvtoolkit.ui.extmarks.MarkInfo?
---@field get_extmark_by_location fun(file:string,line:number,live:boolean):nvtoolkit.ui.extmarks.MarkInfo?
---@field get_extmarks fun(live:boolean):nvtoolkit.ui.extmarks.MarkInfo[]
---@field get_file_extmarks fun(file:string,live:boolean):nvtoolkit.ui.extmarks.MarkInfo[]
---@field refresh fun()

---@param group string
---@param group_opts { priority: number}
---@return nvtoolkit.ui.extmarks.GroupFunctions
function M.define_group(group, group_opts)
    ...
    ---@type nvtoolkit.ui.extmarks.GroupInfo
    local group_info = {
    ...
    ---@type nvtoolkit.ui.extmarks.GroupFunctions
    return {
        ...
        get_extmark_by_location = function(file, line, live)
            return _get_extmark_by_location(file, line, group, live)
        end,
        get_extmarks = function(live)
            return _get_extmarks(group, live)
        end,
        get_file_extmarks = function(file, live)
            return _get_file_extmarks(file, group, live)
        end,
        refresh = function()
