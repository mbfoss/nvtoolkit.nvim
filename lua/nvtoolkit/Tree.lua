---@class nvtoolkit.Tree.Item
---@field id any
---@field data any

---@class nvtoolkit.Tree.ItemUpdate
---@field id any
---@field data any
---@field keep_children boolean

---@class nvtoolkit.Tree.Node
...
---@class nvtoolkit.Tree.FlatNode
---@field id any
---@field data any
---@field depth integer

---@generic T
---@class nvtoolkit.Tree
---@field _nodes table<any, nvtoolkit.Tree.Node>
...
---@private
function Tree:_init()
	---@type table<any, nvtoolkit.Tree.Node>
	self._nodes = {}
...
---@generic T
---@param parent_id any|nil
---@param items nvtoolkit.Tree.Item[]
...
---@param parent_id any|nil
---@param items nvtoolkit.Tree.ItemUpdate[]
...
---@private
---@param node nvtoolkit.Tree.Node
