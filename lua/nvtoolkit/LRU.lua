---@class nvtoolkit.LRU.Node
---@field key any
---@field value any
---@field prev nvtoolkit.LRU.Node?
---@field next nvtoolkit.LRU.Node?

---@class nvtoolkit.LRU
---@field _capacity integer
---@field _count integer
---@field _map table<any, nvtoolkit.LRU.Node>
---@field _head nvtoolkit.LRU.Node?
---@field _tail nvtoolkit.LRU.Node?
...
---@field new fun(self:nvtoolkit.LRU, capacity:integer, opts?:{on_evict?:fun(key:any, value:any), on_removed?:fun(key:any, value:any)}):nvtoolkit.LRU
local LRU = {}
LRU.__index = LRU
